...
5. their average amount per order (formatted to have only 2 decimals)
6. their total discount amount (formatted to have only 2 decimals)
7. their total sales amount including discount (formatted to have only 2 decimals)
8. Their total discount percentage (formatted to have only 2 decimals)
